...
export default function Landing() {
    return <main className="landing-page">
        <nav className="landing-nav"><Link className="landing-brand" to="/">AI-Resulyzer</Link><div>{["Home", "About", "Services", "Contact"].map(item => <a key={item} href={`#${item.toLowerCase()}`}>{item}</a>)}</div><Link className="landing-signin" to="/login">Sign in</Link></nav>
