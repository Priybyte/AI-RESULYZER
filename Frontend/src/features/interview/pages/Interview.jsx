...
const RoadMapDay = ({ day }) => (
    <div className='roadmap-day'>
        <div className='roadmap-day__header'>
            <span className='roadmap-day__badge'>Month {day.day}</span>
...
const Interview = () => {
    ...
    useEffect(() => {
        if (interviewId) {
            getReportById(interviewId).catch((requestError) => setError(requestError.message))
        }
    }, [ interviewId ])
    ...
    if (!report) {
        return <main className='loading-screen'><p className='interview-error' role='alert'>{error || "Unable to load the interview plan."}</p></main>
    }
                    ...
                    {activeNav === 'roadmap' && (
                        <section>
                            <div className='content-header'>
                                ...
                                <span className='content-header__count'>{report.roadmapDurationMonths || report.preparationPlan.length}-month roadmap</span>
                            </div>
